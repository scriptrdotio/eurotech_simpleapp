...
To proceed with the installation step, you need to own a Github account and you need to have generated a Github Personal Access Token the configure your Github settings in scriptr. If you do not wish to do so, you can use the below temporarily:
